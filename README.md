...
## Video
In this [video](https://youtu.be/5B7oLip35_c), we walk through how to train both versions of our CycleGAN and use them to generate images, and how to run our CNN model with and without data augmentation.
